...
```{r}
world_cities <- st_read(here("prac_4", "Data", "World_Countries_Generalized", "World_Countries_Generalized.shp"))

inequality <- read_csv(here("prac_4", "Data", "HDR21-22_Composite_indices_complete_time_series.csv"), na= "")
```
...
inequality_clean <- inequality %>%
  janitor::clean_names()%>%
  dplyr::select(iso3,country,hdicode,hdi_2010,hdi_2011,hdi_2012,hdi_2013,
